...
(function() {
    ...
    this.init = function() {
        ...
        this.level1.tip = (new Notice("Drag or click the resources on the right (->), then add them to the map.", FiercePlanet.Orientation.worldWidth - FiercePlanet.WAVE_NOTICE_WIDTH, FiercePlanet.Orientation.halfWorldHeight));
        ...
        //this.level6.catastrophe = (new Catastrophe(TBL.ECO_CATEGORY, 100 + (Math.random() * 100), 300, 0, new Notice("The city is suffering a financial crisis - all services will be temporarily discontinued...", undefined, undefined, 500, 250, undefined, undefined, TBL.ECO_CATEGORY.color)));
        ...
        this.level10.catastrophe = (new Catastrophe(TBL.SOC_CATEGORY, 500 + (Math.random() * 100), 250, 0.6, new Notice("Oh no! A revolution is coming...", undefined, undefined, 500, 250, undefined, undefined, TBL.SOC_CATEGORY.color)));
        ...
        this.level13 = new Level(13);
        this.level13.allowResourcesOnPath = false;
        this.level13.initialResourceStore = 10;
        this.level13.isPresetLevel = true;
        this.level13.addEntryPoint(0, 6);
        this.level13.addEntryPoint(9, 6);
        this.level13.addExitPoint(6, 10);
        this.level13.addExitPoint(6, 12);
        this.level13.cellsAcross = 13;
        this.level13.cellsDown = 13;
        this.level13.initialAgentNumber = 1;
        this.level13.waveNumber = 10;
        this.level13.expiryLimit = 5;
        this.level13.name = ("Welcome to Baghdad...");
        this.level13.introduction = (""
                + "<p>New threats have emerged....</p>"
                );
        this.level13.conclusion = ("Well done.");
    
        this.level13.setup = function() {
        ...
        this.level14 = new Level(14);
        this.level14.allowResourcesOnPath = false;
        this.level14.initialResourceStore = 100;
        this.level14.isPresetLevel = true;
        this.level14.addEntryPoint(0, 13);
        this.level14.addExitPoint(13, 0);
        this.level14.cellsAcross = 14;
        this.level14.cellsDown = 14;
        this.level14.initialAgentNumber = 1;
        this.level14.waveNumber = 10;
        this.level14.expiryLimit = 10;
        this.level14.name = ("Round and about in Mumbai");
        this.level14.introduction = (""
                + "<p>Easy to get lost in the hazy of the sweltering metropolis.</p>"
                );
        this.level14.conclusion = ("Well done.");
    
        this.level14.setup = function() {
        ...
        this.level15 = new Level(15);
        this.level15.allowResourcesOnPath = false;
        this.level15.initialResourceStore = 150;
        this.level15.isPresetLevel = true;
        this.level15.addEntryPoint(4, 5);
        this.level15.addExitPoint(14, 0);
        this.level15.cellsAcross = 15;
        this.level15.cellsDown = 15;
        this.level15.initialAgentNumber = 1;
        this.level15.waveNumber = 10;
        this.level15.expiryLimit = 10;
        this.level15.name = ("Gremlins in the Kremlin...");
        this.level15.introduction = (""
                + "<p>Looks safe - but things are about to get nasty.</p>"
                );
        this.level15.conclusion = ("Well done.");
    
        this.level15.setup = function() {
        ...
        this.level16 = new Level(16);
        this.level16.isometric = false;
        this.level16.allowOffscreenCycling = true;
        this.level16.allowResourcesOnPath = false;
        this.level16.initialResourceStore = 200;
        this.level16.isPresetLevel = true;
        this.level16.addEntryPoint(0, 14);
        this.level16.addEntryPoint(9, 0);
        this.level16.addEntryPoint(15, 4);
        this.level16.addEntryPoint(15, 10);
        this.level16.addExitPoint(1, 4);
        this.level16.cellsAcross = 16;
        this.level16.cellsDown = 16;
        this.level16.initialAgentNumber = 1;
        this.level16.waveNumber = 5;
        this.level16.expiryLimit = 10;
        this.level16.name = ("On the straight and narrow");
        this.level16.introduction = (""
        ...
        this.level16.conclusion = ("Well done.");
    
        this.level16.setup = function() {
        ...
        this.level17 = new Level(17);
        this.level15.allowResourcesOnPath = false;
        this.level17.initialResourceStore = 150;
        this.level17.isPresetLevel = true;
        this.level17.addEntryPoint(7, 0);
        this.level17.addEntryPoint(1, 10);
        this.level17.addEntryPoint(9, 10);
        this.level17.addExitPoint(9, 8);
        this.level17.cellsAcross = 17;
        this.level17.cellsDown = 17;
        this.level17.initialAgentNumber = 1;
        this.level17.waveNumber = 10;
        this.level17.expiryLimit = 10;
        this.level17.name = ("Laying out the red carpet");
        this.level17.introduction = (""
        ...
        this.level17.conclusion = ("Well done.");
    
        this.level17.setup = function() {
        ...
        this.level18 = new Level(18);
        this.level18.isometric = true;
        this.level18.allowResourcesOnPath = false;
        this.level18.initialResourceStore = 180;
        this.level18.isPresetLevel = true;
        this.level18.addEntryPoint(14, 1);
        this.level18.addExitPoint(15, 2);
        this.level18.cellsAcross = 18;
        this.level18.cellsDown = 18;
        this.level18.initialAgentNumber = 1;
        this.level18.waveNumber = 10;
        this.level18.expiryLimit = 10;
        this.level18.name = ("Clocks and Cheese");
        this.level18.introduction = (""
                + "<p>Welcome to Switzerland!</p>"
                );
        this.level18.conclusion = ("Well done.");
    
        this.level18.setup = function() {
        ...
        this.level19 = new Level(19);
        this.level19.isometric = true;
        this.level19.allowResourcesOnPath = false;
        this.level19.initialResourceStore = 150;
        this.level19.isPresetLevel = true;
        this.level19.addEntryPoint(18, 2);
        this.level19.addExitPoint(9, 18);
        this.level19.cellsAcross = 19;
        this.level19.cellsDown = 19;
        this.level19.initialAgentNumber = 1;
        this.level19.waveNumber = 10;
        this.level19.expiryLimit = 10;
        this.level19.name = ("A day in Dubai.");
        this.level19.introduction = (""
        ...
        this.level19.conclusion = ("Well done.");
    
        this.level19.setup = function() {
        ...
        this.level20 = new Level(20);
        this.level20.isometric = false;
        this.level20.allowResourcesOnPath = false;
        this.level20.initialResourceStore = 1000;
        this.level20.isPresetLevel = true;
        this.level20.addEntryPoint(19, 0);
        this.level20.addExitPoint(0, 19);
        this.level20.cellsAcross = 20;
        this.level20.cellsDown = 20;
        this.level20.initialAgentNumber = 1;
        this.level20.waveNumber = 5;
        this.level20.expiryLimit = 20;
        this.level20.name = ("Spaced Out!");
        this.level20.isTerminalLevel = true;
        this.level20.introduction = (""
                + "<p>Somewhere out there in space there is a...</p>"
                );
        this.level20.conclusion = ("Well done.");
    
        this.level20.setup = function() {
        ...
        this.level21 = new Level(21);
        this.level21.isometric = false;
        this.level21.allowResourcesOnPath = true;
        this.level21.allowOffscreenCycling = true;
        this.level21.initialResourceStore = 0;
        this.level21.isPresetLevel = true;
        this.level21.randomiseAgents = true;
        this.level21.randomiseResources = true;
        //this.level21.addEntryPoint(19, 0);
        this.level21.addExitPoint(10, 10);
        this.level21.cellsAcross = 21;
        this.level21.cellsDown = 21;
        this.level21.initialAgentNumber = 40;
        this.level21.waveNumber = 1;
        this.level21.expiryLimit = 10;
        this.level21.initialResourceNumber = 100;
        this.level21.name = ("The Mini-Sims");
        this.level21.isTerminalLevel = true;
        this.level21.introduction = (""
                + "<p>How very simulating...</p>"
                );
        this.level21.conclusion = ("Well done.");
    
        this.level21.setup = function() {
            this.generatePath();
...
}).apply(FiercePlanet.PresetLevels);