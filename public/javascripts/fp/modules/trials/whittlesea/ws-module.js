...
var WhittleseaWorlds = WhittleseaWorlds || new Campaign();
var WhittleseaModule = WhittleseaModule || {};
var WhittleseaResources = WhittleseaResources || {};
 ...
 */
WhittleseaResources.id = 'WhittleseaResources';
 ...
 */
WhittleseaResources.doSetup = function() {
    // Resource categories
    WhittleseaResources.ECO_CATEGORY = new ResourceCategory("Economic", "eco", "#44ABE0");
    WhittleseaResources.ENV_CATEGORY = new ResourceCategory("Environmental", "env", "#ABBB2A");
    WhittleseaResources.POL_CATEGORY = new ResourceCategory("Political", "pol", "#DE1F2A");
    WhittleseaResources.CUL_CATEGORY = new ResourceCategory("Cultural", "cul", "#2ADBCB");

    // Arrays of resource kinds
    WhittleseaResources.ECONOMIC_RESOURCE_TYPES = [ResourceTypes.STOCKMARKET_RESOURCE_TYPE];
    WhittleseaResources.ENVIRONMENTAL_RESOURCE_TYPES = [ResourceTypes.WASTE_RESOURCE_TYPE];
    WhittleseaResources.POLITICAL_RESOURCE_TYPES = [ResourceTypes.DEMOCRACY_RESOURCE_TYPE];
    WhittleseaResources.CULTURAL_RESOURCE_TYPES = [ResourceTypes.SCHOOL_RESOURCE_TYPE];

    // Clear types
    WhittleseaResources.ECO_CATEGORY.clearTypes();
    WhittleseaResources.ENV_CATEGORY.clearTypes();
    WhittleseaResources.POL_CATEGORY.clearTypes();
    WhittleseaResources.CUL_CATEGORY.clearTypes();

    WhittleseaResources.ECO_CATEGORY.addType(ResourceTypes.STOCKMARKET_RESOURCE_TYPE);
    WhittleseaResources.ENV_CATEGORY.addType(ResourceTypes.WASTE_RESOURCE_TYPE);
    WhittleseaResources.POL_CATEGORY.addType(ResourceTypes.DEMOCRACY_RESOURCE_TYPE);
    WhittleseaResources.CUL_CATEGORY.addType(ResourceTypes.SCHOOL_RESOURCE_TYPE);

    WhittleseaResources.categories = [WhittleseaResources.ECO_CATEGORY, WhittleseaResources.ENV_CATEGORY, WhittleseaResources.POL_CATEGORY, WhittleseaResources.CUL_CATEGORY];
    WhittleseaResources.types =
        _.union(
            WhittleseaResources.ECONOMIC_RESOURCE_TYPES
            , WhittleseaResources.ENVIRONMENTAL_RESOURCE_TYPES
            , WhittleseaResources.POLITICAL_RESOURCE_TYPES
            , WhittleseaResources.CULTURAL_RESOURCE_TYPES
        )
};
...
(function () {
    ...
    this.initWhittleseaWorlds = function () {
...
//                    console.log(sustainabilityIndex, world.totalResidents, totalWasteRemaining)
    ...
    this.initWhittleseaWorlds();
}).apply(WhittleseaWorlds);


(function() {
    this.init = function() {
        var module = new Module();
        module.id = 'Whittlesea';
        module.registerSelf();
        module.registerCampaign(WhittleseaWorlds);
        module.currentCampaignID = 'Whittlesea';
//        module.registerResourceSet(TBL);
        module.registerResourceSet(WhittleseaResources);
        ...
        FiercePlanet.ModuleEditor.buildEditorFromUrl('/javascripts/fp/modules/trials/whittlesea/ws-module.js', 'WhittleseaModule.init(); FiercePlanet.Game.loadGame();');
    };
}).apply(WhittleseaModule);

if (typeof exports !== "undefined") {
    exports.WhittleseaWorlds = WhittleseaWorlds;
    exports.WhittleseaModule = WhittleseaModule;
    exports.WhittleseaResources = WhittleseaResources;
}
