...
var MPMWorlds = MPMWorlds || new Campaign();
var MPMModule = MPMModule || {};
var MPMResources = MPMResources || {};
 ...
 */
MPMResources.doSetup = function() {
    // Resource categories
    MPMResources.ECO_CATEGORY = new ResourceCategory("Economic", "eco", "#44ABE0");
    MPMResources.ENV_CATEGORY = new ResourceCategory("Environmental", "env", "#ABBB2A");
    MPMResources.POL_CATEGORY = new ResourceCategory("Political", "pol", "#DE1F2A");
    MPMResources.CUL_CATEGORY = new ResourceCategory("Cultural", "cul", "#2ADBCB");

    // Arrays of resource kinds
    MPMResources.ECONOMIC_RESOURCE_TYPES = [ResourceTypes.STOCKMARKET_RESOURCE_TYPE];
    MPMResources.ENVIRONMENTAL_RESOURCE_TYPES = [ResourceTypes.WASTE_RESOURCE_TYPE];
    MPMResources.POLITICAL_RESOURCE_TYPES = [ResourceTypes.DEMOCRACY_RESOURCE_TYPE];
    MPMResources.CULTURAL_RESOURCE_TYPES = [ResourceTypes.SCHOOL_RESOURCE_TYPE];

    // Clear types
    MPMResources.ECO_CATEGORY.clearTypes();
    MPMResources.ENV_CATEGORY.clearTypes();
    MPMResources.POL_CATEGORY.clearTypes();
    MPMResources.CUL_CATEGORY.clearTypes();

    MPMResources.ECO_CATEGORY.addType(ResourceTypes.STOCKMARKET_RESOURCE_TYPE);
    MPMResources.ENV_CATEGORY.addType(ResourceTypes.WASTE_RESOURCE_TYPE);
    MPMResources.POL_CATEGORY.addType(ResourceTypes.DEMOCRACY_RESOURCE_TYPE);
    MPMResources.CUL_CATEGORY.addType(ResourceTypes.SCHOOL_RESOURCE_TYPE);

    MPMResources.categories = [MPMResources.ECO_CATEGORY, MPMResources.ENV_CATEGORY, MPMResources.POL_CATEGORY, MPMResources.CUL_CATEGORY];
    MPMResources.types =
        _.union(
            MPMResources.ECONOMIC_RESOURCE_TYPES
            , MPMResources.ENVIRONMENTAL_RESOURCE_TYPES
            , MPMResources.POLITICAL_RESOURCE_TYPES
            , MPMResources.CULTURAL_RESOURCE_TYPES
        )
};
...
(function() {
    this.init = function() {
        ...
        module.id = 'MPM';
        module.registerSelf();
        module.registerCampaign(MPMWorlds);
        module.currentCampaignID = 'MPM';
//        module.registerResourceSet(TBL);
        module.registerResourceSet(MPMResources);
        ...
        FiercePlanet.ModuleEditor.buildEditorFromUrl('/javascripts/fp/modules/trials/mpm/mpm-module.js', 'MPMModule.init(); FiercePlanet.Game.loadGame();');
    };
}).apply(MPMModule);

if (typeof exports !== "undefined") {
    exports.MPMWorlds = MPMWorlds;
    exports.MPMModule = MPMModule;
    exports.MPMResources = MPMResources;
}
