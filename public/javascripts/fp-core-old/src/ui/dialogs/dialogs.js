...
(function() {
    ...
    this.calculateWorldLeft = function () {
        ...
        var contentPaneX = contentPane.position() ? contentPane.position().left : 0;
        var wrapperX = wrapper.position() ? wrapper.position().left : 0;
        var worldX = world.position() ? world.position().left : 0;
        var gameworldX = world.position() ? gameworld.position().left : 0;
    ...
    this.calculateWorldTop = function () {
        ...
        var world = $("#world-container");
        var gameworld = $("#gameworld");
        var contentPaneY = contentPane.position() ? contentPane.position().top : 0;
        var wrapperY = wrapper.position() ? wrapper.position().top : 0;
        var worldY = world.position() ? world.position().top : 0;
        var gameworldY = world.position() ? gameworld.position().top : 0;
        var dialogY = contentPaneY + wrapperY + worldY + gameworldY;
        return dialogY;
//        return dialogY - 178;
    };
